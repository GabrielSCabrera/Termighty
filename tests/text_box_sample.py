...
thread1 = threading.Thread(target=text_box_anim, args = (text_box_1, text, 0.01, 0.3, 0.1,), daemon=True)
thread2 = threading.Thread(target=text_box_anim, args = (text_box_2, text, 0.05, 0.05, 0.01,), daemon=True)
thread3 = threading.Thread(target=text_box_anim, args = (text_box_3, text, 0.001, 0.1, 0.9,), daemon=True)
thread4 = threading.Thread(target=text_box_anim, args = (text_box_4, text, 0.1, 0.1, 0.1,), daemon=True)
